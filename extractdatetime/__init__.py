...
__author__ = 'Rere'
__email__ = 'eample@gmail.com'
__copyright__ = 'Copyright (c) 2020 Mike Taylor'
__license__ = 'Apache License 2.0'
__version__ = '0.0.1'
__url__ = 'https://github.com/rere/extractdatetime'
__download_url__ = 'https://pypi.python.org/pypi/extractdatetime'
...
class Calendar(object):
    ...
    def __init__(self, constants=None, version=VERSION_FLAG_STYLE):
        ...
        if version == VERSION_FLAG_STYLE:
            warnings.warn(
                'Flag style will be deprecated in extractdatetime 2.0. '
                'Instead use the context style by instantiating `Calendar()` '
                'with argument `version=extractdatetime.VERSION_CONTEXT_STYLE`.',
    ...
    def _partialParseDateTStr(self, s, sourceTime):
        """
        test if giving C{s} matched CRE_DATE5, used by L{parse()}
        ...
        m = self.ptc.CRE_DATE5.search(s)
        # NO LONGER NEEDED, THE REGEXP HANDLED MTHNAME NOW
        # for match in self.ptc.CRE_DATE5.finditer(s):
        ...
        #         m = self.ptc.CRE_DATE5.search(s, match.start())
        #         valid_date = True
        #         break
...
class Constants(object):
    ...
    """
    Default set of constants for extractdatetime.
